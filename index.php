<html>
    <head>
        <title>selvasanthosh | Firebase Cloud Messaging</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        if ($include_image) {
            $push->setImage('http://selvasanthosh.com/project_download/firebase/selvasanthosh.png');
        } else {
            $push->setImage('');
        }
        ...
        <div class="container">
            <div class="fl_window">
                <div><img src="http://selvasanthosh.com/project_download/firebase/firebase_logo.png" width="200" alt="Firebase"/></div>
                <br/>
                <?php if ($json != '') { ?>
